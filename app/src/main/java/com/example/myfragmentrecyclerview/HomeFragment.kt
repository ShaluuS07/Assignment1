...
class HomeFragment : Fragment() {
    private lateinit var detailedFragmentCommunicator: HomeFragmentToDetailedFragmentCommunicator
    ...
    override fun onCreateView(
        ...
        detailedFragmentCommunicator = activity as HomeFragmentToDetailedFragmentCommunicator
        return view
    }
